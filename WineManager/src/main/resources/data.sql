...
values ('CHATEAU DE SAINT COSME', '2009', 'Grenache / Syrah', 'France', 'Southern Rhone / Gigondas',
        ...
        'saint_cosme.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('LAN RIOJA CRIANZA', '2006', 'Tempranillo', 'Spain', 'Rioja',
        ...
        'lan_rioja.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('MARGERUM SYBARITE', '2010', 'Sauvignon Blanc', 'USA', 'California Central Cosat',
        ...
        'margerum.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('OWEN ROE "EX UMBRIS"', '2009', 'Syrah', 'USA', 'Washington',
        ...
        'ex_umbris.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('REX HILL', '2009', 'Pinot Noir', 'USA', 'Oregon',
        ...
        'rex_hill.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('VITICCIO CLASSICO RISERVA', '2007', 'Sangiovese Merlot', 'Italy', 'Tuscany',
        ...
        'viticcio.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('CHATEAU LE DOYENNE', '2005', 'Merlot', 'France', 'Bordeaux',
        ...
        'le_doyenne.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('DOMAINE DU BOUSCAT', '2009', 'Merlot', 'France', 'Bordeaux',
        ...
        'bouscat.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('BLOCK NINE', '2009', 'Pinot Noir', 'USA', 'California',
        ...
        'block_nine.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('DOMAINE SERENE', '2007', 'Pinot Noir', 'USA', 'Oregon',
        ...
        'domaine_serene.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('BODEGA LURTON', '2011', 'Pinot Gris', 'Argentina', 'Mendoza',
        'Solid notes of black currant blended with a light citrus make this wine an easy pour for varied palates.',
        'bodega_lurton.jpg');
insert into wine (name, year, grapes, country, region, description, picture)
values ('LES MORIZOTTES', '2009', 'Chardonnay', 'France', 'Burgundy',
